...
public class ClienteDAO {
	...
	public List<ClienteEntity> listarCliente() throws NegocioException{
		...
		String sql = "SELECT ID_CLIENTE, NOME_CLIENTE, TELEFONE_CLIENTE, EMAIL_CLIENTE, ENDERECO_CLIENTE, CPFCPNJ_CLIENTE";
		...
		try {
			...
			while(rs.next()) {
				...
				cli.setCpfcnpj(rs.getString("CPFCPNJ_CLIENTE"));
				clientes.add(cli);
			}
	...
	public ClienteEntity buscarClientePorId(Long codigoCliente) throws NegocioException {
		...
		String sql = "SELECT ID_CLIENTE, NOME_CLIENTE, TELEFONE_CLIENTE, EMAIL_CLIENTE, ENDERECO_CLIENTE, CPFCPNJ_CLIENTE FROM CLIENTE WHERE ID_CLIENTE = ?";
